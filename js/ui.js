const ui = {
    ...
    switchTab(tabId, userRole) {
        const views = ['viewFind', 'viewProfile', 'viewPayment', 'viewRequests', 'viewSession', 'viewManageAvailability', 'viewUpcoming', 'viewRates'];
        views.forEach(id => document.getElementById(id).classList.add('hidden'));

        const tabs = ['tabFind', 'tabRequests', 'tabSession', 'tabAvail', 'tabUpcoming', 'tabRates'];
        tabs.forEach(id => {
        ...
        const map = {
            ...
            'avail': 'viewManageAvailability', 'upcoming': 'viewUpcoming', 'rates': 'viewRates'
        };
